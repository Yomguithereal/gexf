...
This library, while probably still working, should be considered unmaintained and has been replaced by [Graphology's `gexf` module](https://github.com/graphology/graphology/tree/master/src/gexf).
